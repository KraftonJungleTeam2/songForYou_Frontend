            ...
            {filteredSongs.length === 0 ? (
              ...
              filteredSongs.map((song) => (
                <div key={song.id} className='song-item'>
                  ...
                  <div className='buttons has-addons is-right' style={{ width: '8rem' }}>
                    <button className={`button is-dark`} disabled={isReserved(song)} onClick={(e) => !isReserved(song) && handleReserve(e, song)} style={{ height: '2.2rem', width: '3rem' }}>
